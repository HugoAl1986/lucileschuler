...
final class Version20230126145359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD adresse_prestation_id INT DEFAULT NULL, ADD prix_id INT DEFAULT NULL, DROP adresse_prestation_id_id, DROP prix_id_id, CHANGE cheval_id_id cheval_id INT NOT NULL');
        $this->addSql('ALTER TABLE prestation ADD CONSTRAINT FK_51C88FADC8BE953B FOREIGN KEY (cheval_id) REFERENCES cheval (id)');
        ...
        $this->addSql('CREATE INDEX IDX_51C88FADC8BE953B ON prestation (cheval_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD adresse_prestation_id_id INT DEFAULT NULL, ADD prix_id_id INT DEFAULT NULL, DROP adresse_prestation_id, DROP prix_id, CHANGE cheval_id cheval_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE prestation ADD CONSTRAINT FK_51C88FAD6E902F5D FOREIGN KEY (cheval_id_id) REFERENCES cheval (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('CREATE INDEX IDX_51C88FAD6E902F5D ON prestation (cheval_id_id)');
