...
final class Version20230126140206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prestation (id INT AUTO_INCREMENT NOT NULL, horse_id_id INT NOT NULL, adresse_prestation_id_id INT DEFAULT NULL, prix_id_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_51C88FAD6E902F5D (horse_id_id), INDEX IDX_51C88FADB3C20B3F (adresse_prestation_id_id), INDEX IDX_51C88FAD9F0BF009 (prix_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prestation ADD CONSTRAINT FK_51C88FAD6E902F5D FOREIGN KEY (horse_id_id) REFERENCES horse (id)');
